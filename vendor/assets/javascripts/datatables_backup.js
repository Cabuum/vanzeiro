...
$(document).ready(function() {
    ...
    $(document).on("page:change", function () {
        ...
        '<a class="btn dropdown-toggle btn-primary" data-toggle="dropdown" href="#"> Adicionar</a>'+
        '<ul class="dropdown-menu">'+
        '<li><a href="/fluxo-de-caixa/categorias/novo">Categoria</a></li>'+
        '<li><a href="/fluxo-de-caixa/novo">Movimento</a></li>'+
        '</ul>'+
        '</div>');
